...
export class SearchCVServiceService {
  ...
  _createMockCV() {
    let i = 0;
    return [
      { id: i++, title: 'engineer', profile: 'here goes your introduction', workExp: 'this is the description of the cv', education: 'bruto muy bruto',active:true,languages:'English, French, Spanish' },
      { id: i++, title: 'developper', profile: 'here goes your introduction', workExp: 'this is the description of the cv', education: 'bruto muy bruto',active:false,languages:'English, French, Spanish'  },
